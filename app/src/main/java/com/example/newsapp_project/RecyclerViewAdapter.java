...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder>{
    ...
    holder.mtime.setText("Published At:-"+ modelClassArrayList.get(holder.getAdapterPosition()).getPublishedAt());
    holder.mauthor.setText(modelClassArrayList.get(holder.getAdapterPosition()).getAuthor());
    holder.mheading.setText( modelClassArrayList.get(holder.getAdapterPosition()).getTitle());
